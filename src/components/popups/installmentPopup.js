...
import { setDispatchPopup } from '../../store/dispatchPopup';

const InstallMentPopup = (props) =>{
            ...
            <MonthSelectWrapper>
                ...
                <MonthSelectPickerWrapper>
                    ...
                    <View style={{flexDirection:'row', width:'100%', justifyContent:'center', paddingTop:7 }}>
                            ...
                            <TouchableWithoutFeedback  onPress={()=>{ dispatch(setDispatchPopup({isOkClicked:true,returnData:{installment:monthSelected}}));  }}>
                            ...
                            <TouchableWithoutFeedback onPress={()=>{  dispatch(setDispatchPopup({isCancelClicked:true})); }}>
